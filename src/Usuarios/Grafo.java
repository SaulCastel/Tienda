...
public class Grafo extends javax.swing.JFrame {
    ...
    public Grafo(Usuario user) {
        initComponents();
        setLocationRelativeTo(null);
        this.user = user;
        Grafico.setIcon(imagenLabel());
    }
    
    private ImageIcon imagenLabel(){
        String dirPng = "C:\\Users\\Saul\\Desktop\\Lista.png";
        String dirDot = "C:\\Users\\Saul\\Desktop\\Lista.txt";
        try {
            String cmd = "C:\\Program Files (x86)\\Graphviz2.38\\bin\\dot "
                    + " -Tpng " + " -o " + " " + dirPng + " " + dirDot;
            Runtime rt = Runtime.getRuntime();
            rt.exec(cmd);
        } catch (Exception e) {
            e.printStackTrace();
        }
        Image original = new ImageIcon(dirPng).getImage();
        ImageIcon imagenLabel = new ImageIcon(original);
        return imagenLabel;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Carrito volver = new Carrito(user);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Grafo(new Usuario()).setVisible(true);
            }
        });
    }
