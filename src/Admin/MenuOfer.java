 ...
 * @author Saul
 */
public class MenuOfer extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuOfer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
